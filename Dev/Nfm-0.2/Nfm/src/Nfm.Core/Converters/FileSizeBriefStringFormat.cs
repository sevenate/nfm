// <copyright file="FileSizeBriefStringFormat.cs" company="HD">
...
// 	<date>2009-06-09</date>
// </editor>
// <summary>Holds all string formats required to show brief file size.</summary>

namespace Nfm.Core.Converters
{
	/// <summary>
	/// Holds all string formats required to show brief file size.
	/// </summary>
	public class FileSizeBriefStringFormat
	{
		...
		/// </summary>
		public FileSizeUnit KByteUnit { get { return FileSizeUnit.KiloByte; } }
		...
		/// </summary>
		public FileSizeUnit MByteUnit { get { return FileSizeUnit.MegaByte; } }
		...
		/// </summary>
		public FileSizeUnit GByteUnit { get { return FileSizeUnit.GigaByte; } }

		/// <summary>
		/// Gets or sets gigabyte-sized file precision.
		/// </summary>
		public FileSizePrecision GBytePrecision { get { return FileSizePrecision.OneDecimalPlaces; } }

		/// <summary>
		/// Gets or sets mesearing unit for terabyte-sized files.
		/// </summary>
		public FileSizeUnit TByteUnit { get { return FileSizeUnit.TeraByte; } }

		/// <summary>
		/// Gets or sets terabyte-sized file precision.
		/// </summary>
		public FileSizePrecision TBytePrecision { get { return FileSizePrecision.TwoDecimalPlaces; } }
